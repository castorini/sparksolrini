...
import (
	...
	openapi "k8s.io/kube-openapi/pkg/cs848.util/proto"
)
...
func (s PatchMetaFromStruct) LookupPatchMetadataForSlice(key string) (LookupPatchMeta, PatchMeta, error) {
	...
	// e.g. https://github.com/kubernetes/kubernetes/blob/bc22e206c79282487ea0bf5696d5ccec7e839a76/staging/src/k8s.io/apimachinery/pkg/cs848.util/strategicpatch/patch_test.go#L2782-L2822
